...
public class EDbean implements Serializable{
	...
	/**
	 * Setzt das Attribut ChangePresentIngredient auf den Wert der Id, welche eingegeben wird.
	 * 
	 * @param sId - String
	 * 
	 * @autor: Eddi M.
	...
	private void aktualisierePercent(int fId){
		...
		for (int i=0; i< this.getTotalIngredients(); i++){
			if (this.modelData.getIngredients().getIngredient().get(i).isActive() == true && this.modelData.getIngredients().getIngredient().get(i).getActive() == true && model.getIdsOfPresentIngredientsFromPresentFertiliser(model.getPresentFertiliser(fId)).contains(i) == true ){
	...
	public String getVorhandenDuengerTableau(){
		...
		out += "deleted ";
		if (this.getShowDeletedPresentFertiliser() == true){
			out += this.getImageAndToolTip(Images.Invisible);
//				out += "<input type=\"hidden\" name=\"action\" value=\"24_dontshowDeletedIngredients\"/>";
		}else {
			out += this.getImageAndToolTip(Images.Visible);
//				out += "<input type=\"hidden\" name=\"action\" value=\"23_showDeletedIngredients\"/>";
		...
		for (int i=0; i< this.getTotalPresentFertilisers(); i++ ){
			...
			if (fertiliser.isActive() == true && (fertiliser.getActive() == true || this.getShowDeletedPresentFertiliser() == true)){
				...
				if (i == this.getChangePresentFeritliser() && (right.equals("x") || right.equals("w"))){
					out += "<form action=\"Controller\" method=\"post\" />";
					out += "<td><input type=\"text\"  class=\"form-control\" name=\"fertiliserName\" value=\""+fertiliser.getName()+ "\"/></td>";
...
//					out += "<input type=\"hidden\" name=\"action\" value=\"06_editIngredient\"/>";
				...
				out += "</th>";
				out += "<th>Name</th><th>";
				if (fertiliser.hatPresentIngredients() == true){
					out += "<form action=\"Controller\" method=\"post\" />";
	...
	private String getDeletePresentFertiliserButton(PresentFertiliser fertiliser){
		String out = "";
		if (this.getShowDeletedPresentFertiliser() == true && fertiliser.getActive() == false){
			out += "<form action=\"Controller\" method=\"post\" />";
			out += "<td>";
			out += this.getImageAndToolTip(Images.Add);
			out += "</td>";
...
//			out += "<input type=\"hidden\" name=\"action\" value=\"22_deleteIngredients\" />";
	...
	private double getTotalPercentOfPresentIngredients(int presentFertiliserId){
		...
		for (int i=0; i< this.getTotalIngredients(); i++){
			if (this.modelData.getIngredients().getIngredient().get(i).isActive() == true && this.modelData.getIngredients().getIngredient().get(i).getActive() == true && model.getIdsOfPresentIngredientsFromPresentFertiliser(presentFertiliser).contains(i) == true){
	...
	public void solve(){
		...
		String[] ingredientName 	= new String[this.getTotalIngredients()];
		double[] purchase_priceVal 	= new double[this.getTotalIngredients()];
		for(int j=0; j<this.getTotalIngredients(); j++){
