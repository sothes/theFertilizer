...
public class PresentFertiliser {
    ...
    /**
     * Ruft den Wert der presentIngredients-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der presentIngredients-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link PresentIngredients }
    ...
    public boolean hatPresentIngredients(){
    	if (this.presentIngredients == null){
    		return false;
    	}else{
    		return true;
    	}
