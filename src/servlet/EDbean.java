...
public class EDbean implements Serializable{
	...
	/**
	 * Dieses Attribut ist fuer die Bearbeitung von vorhandenen Ingredients da.
	 * 
	...
	/**
	 * Dieses Attribut ist fuer die Bearbeitung von vorhandenen PresentIngredients da.
	 * 
	 */
	private int ChangePresentIngredientId = -1;
	
	/**
	 * Dieses Attribut ist fuer die Bearbeitung von vorhandenen Fertilisers da.
	 * 
	 */
	...
	/**
	 * Diese Funktion aktualisiert die Prozentwerte der vorhandenen PresentIngrediens, wenn der Gesamtwert ueber 100 % sein sollte.
	...
	/**
	 * liefert HTML String fuer Vorhandenen Duenger
	 * @return
	 */
	public String getVorhandenDuengerTableau(){
		...
		for (int i=0; i< this.getNrDuengerVorhanden(); i++ ){
			...
			/**
			 * Neue Zutaten koennen hinzugefuegt werden.
			 * Zeile zum einfuegen.
			 * autor: Edgar Muss
			 */
			out += "<form action=\"Controller\" method=\"post\" />";
	...
	/**
	 * lieftert den HTML String zur Modell-uebersicht
	 * @return
	 */
	...
	/**
	 * liefert den HTML String zum Hinzufuegen eines Modells
	 * 
	 * @return
	 */
	...
	/**
	 * loest das Modell
	 * Dazu werden die Modelldaten an den Solver uebergeben.
	 * Nach der Loesung werden die Loesungsdaten in die Klasse data.model
	 * uebertragen
	 */
	public void solve(){
